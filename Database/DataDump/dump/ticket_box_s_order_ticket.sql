...
CREATE TABLE `s_order_ticket` (
  ...
  `ownercid` varchar(255) DEFAULT NULL,
  ...
  KEY `FKjldhyumorsvobb7d8mbd8h1pl` (`relationship_id`),
  ...
  CONSTRAINT `FKjldhyumorsvobb7d8mbd8h1pl` FOREIGN KEY (`relationship_id`) REFERENCES `s_relationship` (`id`),
...
-- Dump completed on 2025-11-05 11:27:18
